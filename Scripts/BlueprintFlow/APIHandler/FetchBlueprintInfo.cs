namespace BlueprintFlow.APIHandler
{
    ...
    [Preserve]
    [LocalDataOnly]
    public sealed class BlueprintInfoData : IWritableData
    {
    ...
    public class FetchBlueprintInfo
    {
        ...
        [Preserve]
        public FetchBlueprintInfo(UserDataManager userDataManager)
        {
        ...
        public async Task<BlueprintInfoData> GetBlueprintInfo(string fetchUri)
        {
            ...
            catch (Exception e)
            {
                ...
                return await this.userDataManager.LoadAsync<BlueprintInfoData>();
            }
        }
    }
    #endif
